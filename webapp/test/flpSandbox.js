		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#geosalesgeosales-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"geosalesgeosales-display": {
								"semanticObject": "geosalesgeosales",
								"action": "display",
								"description": "Monitoreo de ventas en tiempo real",
								"title": "Monitor de Ventas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=geosales.geosales",
									"url": sap.ui.require.toUrl("geosales/geosales")
								}
							}
						}
					}
